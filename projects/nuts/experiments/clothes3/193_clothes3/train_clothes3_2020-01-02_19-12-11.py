...
def add_exp_args():
    ...
    parser.add_argument('--weights',        default=None,       type=str,  help='Put the path to resuming file if needed')
    ...
    parser.add_argument('--seg-num-epochs', default=160,        type=int,  help='num epochs without train_proposals')
