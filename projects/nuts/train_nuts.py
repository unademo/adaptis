...
from projects.nuts.segtrainer import SegTrainer
...
def add_exp_args():
    ...
    parser.add_argument('--gpus',           default='2,3',      type=str,  required=False)
    parser.add_argument('--batch-size',     default=4,          type=int, )
    parser.add_argument('--exp-name',       default='nuts', type=str,  help='experiment name')
    parser.add_argument('--start-epoch',    default=0,          type=int,  help='Start epoch for learning schedule and for logging')
    parser.add_argument('--weights',        default="",         type=str,  help='Put the path to resuming file if needed')
    ...
    parser.add_argument('--dataset',        default="NutsDataset", type=str,  help='dataset')
    parser.add_argument('--dataset-path',   default="/path/to/dataset", type=str,  help='Path to the dataset')
...
if __name__ == '__main__':
    ...
    # Init args
    args = init_experiment(experiment_name='nuts',
